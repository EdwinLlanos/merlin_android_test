 ...
 */
package com.merlinjobs.currencyexchange.common

import android.app.Application
import android.content.Context
import com.merlinjobs.currencyexchange.BuildConfig
...
abstract class AndroidTest {
    ...
    fun activityContext(): Context = mock(SplashScreenActivity::class.java)
